...
class Platform(Base):
    def __init__(self, opt):
        ...
        self._app.add_url_rule('/database/', defaults={'req_path': ''}, view_func=self.__dir_listing, methods=['GET'])
        self._app.add_url_rule('/database/<path:req_path>', view_func=self.__dir_listing, methods=['GET'])
